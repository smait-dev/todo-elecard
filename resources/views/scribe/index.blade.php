...
<i>optional</i> &nbsp;
               ...
               step="any"               name="limit"                data-endpoint="GETapi-v1-tasks"
               value="1"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="offset"                data-endpoint="GETapi-v1-tasks"
               value="39"
               data-component="body">
    <br>
...
Must be one of:
<ul style="list-style-type: square;"><li><code>new</code></li> <li><code>in_progress</code></li> <li><code>done</code></li></ul>
        </div>
        </form>
